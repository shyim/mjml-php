...
final class MjText extends BodyComponent
{
    ...
    public function render(): string
    {
        ...
        if ($height !== null) {
            return '<!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td height="' . $height . '" style="vertical-align:top;height:' . $height . ';"><![endif]-->'
                . $this->renderContent()
