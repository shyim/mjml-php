...
final class AccordionTitleFontWeightTest extends AbstractIntegrationTest
{
    public function testAccordionTitleFontWeight(): void
    {
        $mjml = '
        <mjml>
          <mj-head>
        ...
        $fontWeightValues = $this->collectStyleValues($html, '.accordion-title', 'font-weight');
        self::assertSame(['bold', '700'], $fontWeightValues);
    }
}
